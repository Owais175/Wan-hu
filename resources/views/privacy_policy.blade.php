@php
    $page = \Illuminate\Support\Facades\DB::table('pages')->where('id', 42)->first();
    $sections = \Illuminate\Support\Facades\DB::table('section')->where('page_id', 42)->get();
    $banners = \Illuminate\Support\Facades\DB::table('banners')->get();
@endphp

@extends('layouts.app')
@section('title', 'Home')
<link rel="canonical" href="https://roymontzauthor.com/privacy_policy" />
@section('css')
@endsection
